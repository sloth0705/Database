...
INSERT INTO `User2` VALUES ('B101', '김유신', '010-1234-4444', 25);
...
INSERT INTO `User4` (`name`, `gender`, `age`, `addr`) VALUES ('신사임당', 1, 47, '강릉시');
...
#실습 2-13
ALTER TABLE `User5` CHANGE CLOLUMN `addr` `address` VARCHAR(100);
